...
const routes: Routes = [
    { path: ROUTES.MARKET_PAGE, loadChildren: () => import("@modules/main-list/main-list-routing.module").then((m) => m.MainListRoutingModule) },
    { path: ROUTES.ROOT, loadChildren: () => import("@modules/main-list/main-list-routing.module").then((m) => m.MainListRoutingModule) },
